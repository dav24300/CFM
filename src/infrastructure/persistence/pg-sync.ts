...
const TABLE_SPECS: TableSpec[] = [
  ...
  },
  {
    ...
    pk: "id",
    pkType: "int",
    cols: ["id", "email", "password_hash", "first_name", "last_name", "phone", "phone_e164", "province", "role", "membership_type", "military_link", "parent_military_name", "skills", "status", "verified_at", "password_changed_at", "created_at"],
